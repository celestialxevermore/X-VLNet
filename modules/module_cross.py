...
from .pretrained_model import PreTrainedModel, LayerNorm, ACT2FN
...
#     def attention(self, x: torch.Tensor, y: torch.Tensor, attn_mask: torch.Tensor):
#         attn_mask_ = attn_mask.repeat_interleave(self.n_head, dim=0)
...
#         # print(para_tuple)
#         print(para_tuple)
#         x,y, attn_mask = para_tuple
#         x = x + self.attention(self.ln_1(x),self.ln_1(y), attn_mask)
#         x = x + self.mlp(self.ln_2(x))
#         return (x, attn_mask)
...
#         return self.resblocks((x,y,attn_mask))[0]
